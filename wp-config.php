 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'g+ktdKw0|j$N[w#;;rpF-$T0rU~hzfA7}@kkJA)bYk~@2SnAKbon>@iYT0;OS~Gz');
define('SECURE_AUTH_KEY',  'e?P#XqNP6 (bR{XR&^?$2/Qmv}rQ{)!6AF@J:e(]?-Pxr;LG-33!u0Y9I,4n3+!1');
define('LOGGED_IN_KEY',    'DKvyi:&sH?8lw+~`:McN+9yWLZ|0j5/+-6):3XJ&iDDhJI#EA1!FHql5AOdtvM;L');
define('NONCE_KEY',        '_4VY[{$5>3v2F*yFBYIJ*|_df[k/Mz3%=.~a@iX3|Wa-~7vh},|U 1{4 qi7yKZn');
define('AUTH_SALT',        'L&#tpZ7G(x_Rf!Mvy.EZmjp(DUqPF+}uRyk8czM-]EyCEc39+T:6zY@|iw!<-mef');
define('SECURE_AUTH_SALT', 'QI^GWGV/(^8PN%NxI?xERhsr`3-yJ.^9porfg3;xLi;B*ei=zN}ios!f/Hh><kaR');
define('LOGGED_IN_SALT',   'J2Whhx.3<{2dhv~i:2[e8P:HRe3z`I0P$wz|`3pjb%7EO-%Q<{}Uv-:^pL]bnpe{');
define('NONCE_SALT',       'WE *QO#i,$iO8uQV1AETyp=!z O1zzU-`!{}X..AJQqw#M**m/u%r V5<O*Cfs]w');
